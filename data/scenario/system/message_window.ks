;メッセージレイヤの定義
		...
		[position width=1240 height=300 top=180 left=20 ]
		...
		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=45 x=30 y=427 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=1240 height=300 top=180 left=20 ]
